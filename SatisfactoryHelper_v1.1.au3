...
HotKeySet("!{F5}", "_SetCraftCoords") ; Hold mouse over CRAFT button and press 'Alt'+'F5' to set the location of your button.
HotKeySet("{F6}", "_ClickCraft") ; Press F6 to start crafting
HotKeySet("{F7}", "_UnClickCraft") ; Press F7 to stop crafting
